...
Have you ever wondered about how to deploy a **3-tier** web application, especially a containerised Go web application on the AWS cloud platform?

This is a Go-based web application where users can **set, track, and share life goals and aspirations**. This project demonstrates how to design and deploy a **production-ready cloud infrastructure** for a Go web application using AWS and Terraform.
The infrastructure follows **cloud-native best practices** including containerization, infrastructure as code, automated deployments, high availability, and secure secret management. The entire system is deployed using **Terraform modules and workspaces**, enabling multiple environments such as **development, staging, and production**.
...
- Automatic scaling of EC2 instances using **Auto scaling group (ASG)** scaling policy based on a certain CPU threshold
...
- NAT gateway to allow Go application instances located in the private app subnet to access internet-based resources
